...
public class StockUtil {
	...
	public static void addStock(StockInfo si) {
		prices.put(si.ticker, si.price);
	}
	
	public static boolean doesExist(final String ticker) {
		return prices.containsKey(ticker);
	}
